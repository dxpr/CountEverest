(() => {
  class CountEverest {
    ...
    constructor(e, t) {
      console.log('DEBUG: CountEverest constructor called', { element: e, options: t }),
        ...
        e.id && CountEverest._instances.set(e.id, this),
        (this.#s = null),
        this.init();
    }
    #e;
    ...
    init() {
      if (
        (console.log('DEBUG: init() called', { element: this.#e, settings: this.#t }),
        this.createDOM(),
    ...
    destroy() {
      clearInterval(this.#s), this.#e.id && CountEverest._instances.delete(this.#e.id);
    }
    strPad(e, t, s = '0') {
    ...
    static destroyInstance(e) {
      const t = CountEverest._instances.get(e);
      return !!t && (t.destroy(), !0);
    }
    static initElement(e) {
      console.log('DEBUG: initElement() called', {
        element: e,
        initialized: e.dataset.ceInitialized,
      });
      const t = CountEverest.parseDataAttributes(e);
      console.log('DEBUG: parsed options', t),
        CountEverest.applyThemeOptions(e, t),
        (t._themeApplied = !0),
        (e.dataset.ceInitialized = 'true'),
        console.log('DEBUG: Creating new CountEverest instance'),
    ...
    createDOM() {
      if (
        (console.log('DEBUG: createDOM() called', {
          element: this.#e,
          innerHTML: this.#e.innerHTML.trim(),
          isEmpty: '' === this.#e.innerHTML.trim(),
        }),
        '' !== this.#e.innerHTML.trim())
      )
        return void console.log('DEBUG: Element already has content, skipping DOM creation');
      const e = [],
        t = this.#t.units;
      this.#e.classList.contains('ce-countdown--theme-1')
        ...
        console.log('DEBUG: DOM created', { htmlParts: e, finalHTML: this.#e.innerHTML });
    }
  }
