  ...
  class e {
    ...
    static theme9DrawCircles(e, t, s = '#284ED8') {
      ...
      a.units.forEach((s) => {
        const n = i[s];
        if (n) {
          const a = e.querySelector(`.ce-${s}`);
          a && (a.textContent = n.pad ? t.strPad(n.value, 2) : n.value);
        }
      }),
