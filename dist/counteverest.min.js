  ...
  class e {
    ...
    constructor(t, s) {
      (e.DEFAULT_SETTINGS = {
        ...
        (this.#e = t),
        (this.#t = { ...e.DEFAULT_SETTINGS, ...s }),
        s._themeApplied || e.applyThemeOptions(t, this.#t),
        (t._ceSettings = this.#t),
    ...
    init() {
      if (
        (this.createDOM(),
        this.#e.classList.contains('ce-countdown--theme-9') && e.createCanvasesIfNeeded(this.#e),
    ...
    calculate() {
      const e = new Date(),
        t = this.#n;
      let s = t - e;
      Math.abs(s), (s = this.#t.countUp ? e - t : Math.max(0, s));
      const n = 864e5,
        a = {};
      let i = s;
      [
        ...
        this.#t.units.includes(e.name) && ((a[e.name] = Math.floor(i / e.ms)), (i %= e.ms));
      }),
    ...
    destroy() {
      clearInterval(this.#s), this.#e.id && e._instances.delete(this.#e.id);
    }
    strPad(e, t, s = '0') {
    ...
    static initElement(t) {
      const s = e.parseDataAttributes(t);
      e.applyThemeOptions(t, s),
        (s._themeApplied = !0),
