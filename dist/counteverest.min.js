  ...
  class CountEverest {
    ...
    init() {
      this.setTargetDate(
        ...
        this.calculate(),
        (this.#s = setInterval(() => this.calculate(), this.#t.timeout)),
        this.#t.onInit?.call(this);
    }
    calculate() {
      'function' == typeof this.#t.beforeCalculation && this.#t.beforeCalculation.call(this);
      const e = new Date(),
        t = this.#i;
      let s = t - e;
      s = this.#t.countUp ? e - t : Math.max(0, s);
      const i = ['years', 'days', 'hours', 'minutes', 'seconds', 'milliseconds'].reduce(
        (e, t) => (
          (e[t] = Math.floor(s / this.#t[`${t.slice(0, -1)}InMilliseconds`])),
          (s %= this.#t[`${t.slice(0, -1)}InMilliseconds`]),
          e
        ),
        {}
      );
      Object.assign(this, i),
        ...
        s <= 0 &&
          ...
          'function' == typeof this.#t.onComplete && this.#t.onComplete.call(this)),
    ...
    output() {
      ['years', 'days', 'hours', 'minutes', 'seconds'].forEach((e) => {
        const t = this[e],
          s = this.#t[`${e}Wrapper`],
          i = this.#t[`${e}LabelWrapper`],
          n = this.#e.querySelector(s);
        n && (n.innerHTML = this.wrapDigits(t)), this.writeLabelToDom(i, this.getLabel(e, t));
      });
    }
    wrapDigits(e) {
      return e
    ...
    getLabel(e, t) {
      const s = `${e.slice(0, -1)}Label`,
        i = `${e}Label`;
      return 1 === t && this.#t.singularLabels ? this.#t[s] : this.#t[i];
    }
    setTargetDate(e) {
      this.#i = e;
    }
